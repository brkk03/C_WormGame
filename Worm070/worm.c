...
enum ResCodes doLevel() {
    ...
    switch (game_state) {
      ...
      if (getNumberOfFoodItems(&theboard) == 0) {
        showDialog("Sie haben diese Runde erfolgreich beendet !!!","Bitte Taste drücken...");
      }else {
      ...
      break;
      case WORM_CRASH:
      showDialog("Sie haben das Spiel verloren,""weil Sie in die Barriere gefahren sind", "Bitte Taste drücken...");
      break;
